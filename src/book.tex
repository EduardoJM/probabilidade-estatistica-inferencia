...
Sejam $A$ e $B$ eventos de $S$, então a probabilidade de que ocorra um destes dois eventos, um diagrama está na Figura \ref{picture:eventos_intersessao}, $A$ ou $B$, é dada por
\begin{equation}
