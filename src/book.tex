...
\todo{falar sobre a tabela de números aleatórios}
...
\todo{fazer os dois exemplos das folhas}
...
\todo{indicar fonte para a tabela?}
...
\todo{Estatística Descritiva, Tipos de variáveis.}

\todo{Representação Gráfica.}
...
\todo{Falar das três e mostrar seus respectivos exemplos (tabelas).}

\section{Medidas Separatrizes}

\subsection{Quartis}

\todo{Falar dos quartis.}

\subsection{Percentis}

\todo{Falar dos percentis.}

\subsection{Aproximação para o Cálculo dos Percentis}

\todo{Falar dessas aproximações.}
